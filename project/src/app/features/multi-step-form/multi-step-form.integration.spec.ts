...
describe('MultiStepForm Integration', () => {
  ...
  function clickButton(selector: string) {
    ...
    expect(btn).withContext(`Expected button: ${selector}`).toBeTruthy();
    btn!.click();
    fixture.detectChanges();
  }
  ...
  function inputText(selector: string, text: string) {
    ...
    expect(input).withContext(`Expected input: ${selector}`).toBeTruthy();
    input!.value = text;
    input!.dispatchEvent(new Event('input'));
    fixture.detectChanges();
  }

  it('should complete the multi-step form and reach thank you page', async () => {
